...
const mockEvents: HivemindEvent[] = [
  ...
  {
    id: 'evt-4a', type: 'CheckpointCommitCreated', category: 'verification',
    timestamp: '2025-02-07T10:17:00Z', sequence: 5,
    correlation: { project_id: 'proj-1', graph_id: 'graph-1', flow_id: 'flow-1', task_id: 'task-2', attempt_id: 'att-1' },
    payload: { checkpoint_id: 'checkpoint-1', commit_hash: 'a1b2c3d', total: 3 },
  },
  {
    id: 'evt-4b', type: 'CheckpointCommitCreated', category: 'verification',
    timestamp: '2025-02-07T10:17:30Z', sequence: 6,
    correlation: { project_id: 'proj-1', graph_id: 'graph-1', flow_id: 'flow-1', task_id: 'task-2', attempt_id: 'att-1' },
    payload: { checkpoint_id: 'checkpoint-2', commit_hash: 'e4f5g6h', total: 3 },
  },
  {
    id: 'evt-4c', type: 'CheckpointCommitCreated', category: 'verification',
    timestamp: '2025-02-07T10:17:50Z', sequence: 7,
    correlation: { project_id: 'proj-1', graph_id: 'graph-1', flow_id: 'flow-1', task_id: 'task-2', attempt_id: 'att-1' },
    payload: { checkpoint_id: 'final-checkpoint', commit_hash: 'i7j8k9l', total: 3, all_checkpoints_completed: true },
  },
  {
    id: 'evt-5', type: 'TaskExecutionStateChanged', category: 'execution',
    timestamp: '2025-02-07T10:18:00Z', sequence: 8,
  ...
  },
  {
    ...
    timestamp: '2025-02-07T10:17:22Z', sequence: 9,
  ...
  },
  {
    ...
    timestamp: '2025-02-07T10:19:00Z', sequence: 10,
  ...
  },
  {
    ...
    timestamp: '2025-02-07T10:20:15Z', sequence: 11,
  ...
  },
  {
    ...
    timestamp: '2025-02-07T10:23:00Z', sequence: 14,
  ...
  },
  {
    ...
    timestamp: '2025-02-07T10:24:00Z', sequence: 15,
  ...
  {
    id: 'evt-13', type: 'CheckpointCommitCreated', category: 'verification',
    timestamp: '2025-02-07T09:00:00Z', sequence: 16,
    correlation: { project_id: 'proj-1', graph_id: 'graph-1', flow_id: 'flow-1', task_id: 'task-1', attempt_id: null },
    payload: { checkpoint_id: 'scheduler-init', commit_hash: 'abc1234', total: 4 },
  },
  {
    id: 'evt-14', type: 'CheckpointCommitCreated', category: 'verification',
    timestamp: '2025-02-07T09:15:00Z', sequence: 17,
    correlation: { project_id: 'proj-1', graph_id: 'graph-1', flow_id: 'flow-1', task_id: 'task-1', attempt_id: null },
    payload: { checkpoint_id: 'dependency-resolution', commit_hash: 'def5678', total: 4 },
  },
  {
    id: 'evt-15', type: 'CheckpointCommitCreated', category: 'verification',
    timestamp: '2025-02-07T09:30:00Z', sequence: 18,
    correlation: { project_id: 'proj-1', graph_id: 'graph-1', flow_id: 'flow-1', task_id: 'task-3', attempt_id: null },
    payload: { checkpoint_id: 'event-store', commit_hash: 'xyz9876', total: 2 },
  },
  {
    id: 'evt-16', type: 'CheckpointCommitCreated', category: 'verification',
    timestamp: '2025-02-07T08:00:00Z', sequence: 19,
    correlation: { project_id: 'proj-1', graph_id: 'graph-2', flow_id: 'flow-2', task_id: 'task-5', attempt_id: null },
    payload: { checkpoint_id: 'override-ui', commit_hash: 'qwe4567', total: 3 },
  },
  {
    id: 'evt-17', type: 'CheckpointCommitCreated', category: 'verification',
    timestamp: '2025-02-07T08:30:00Z', sequence: 20,
    correlation: { project_id: 'proj-1', graph_id: 'graph-2', flow_id: 'flow-2', task_id: 'task-6', attempt_id: null },
    payload: { checkpoint_id: 'merge-prepare', commit_hash: 'rty8901', total: 3 },
  },
  {
    id: 'evt-18', type: 'CheckpointCommitCreated', category: 'verification',
    timestamp: '2025-02-07T08:45:00Z', sequence: 21,
    correlation: { project_id: 'proj-1', graph_id: 'graph-2', flow_id: 'flow-2', task_id: 'task-6', attempt_id: null },
    payload: { checkpoint_id: 'merge-approve', commit_hash: 'uio2345', total: 3 },
  },
  {
    id: 'evt-19', type: 'CheckpointCommitCreated', category: 'verification',
    timestamp: '2025-02-07T07:30:00Z', sequence: 22,
    correlation: { project_id: 'proj-1', graph_id: 'graph-2', flow_id: 'flow-2', task_id: 'task-7', attempt_id: null },
    payload: { checkpoint_id: 'worktree-create', total: 2 },
  },
];
